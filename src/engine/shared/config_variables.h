...
MACRO_CONFIG_INT(SvShowClientDummysInMaster, sv_show_client_dummys_in_master, 0, 0, 1, CFGFLAG_SERVER, "0=hides clientdummys in master 1=shows clientdummys in master")
