...
CConsole::CConsole(int FlagMask)
{
	...
	Register("echo", "r[text]", CFGFLAG_SERVER, Con_Echo, this, "Echo the text", AUTHED_HELPER);
	...
	Register("access_status", "i[accesslevel]", CFGFLAG_SERVER, ConCommandStatus, this, "List all commands which are accessible for admin = 0, moderator = 1, helper = 2, all = 3", AUTHED_ADMIN);
