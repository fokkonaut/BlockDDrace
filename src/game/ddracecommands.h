...
CONSOLE_COMMAND("infatom", "?v[id]", CFGFLAG_SERVER, ConInfAtom, this, "Toggles infinite atom for player v", AUTHED_ADMIN)
CONSOLE_COMMAND("trail", "?v[id]", CFGFLAG_SERVER, ConTrail, this, "Toggles trail for player v", AUTHED_ADMIN)
CONSOLE_COMMAND("inftrail", "?v[id]", CFGFLAG_SERVER, ConInfTrail, this, "Toggles infinite for player v", AUTHED_ADMIN)
