...
CONSOLE_COMMAND("addweapon", "i[weapon-id] ?v[id]", CFGFLAG_SERVER|CMDFLAG_TEST, ConAddWeapon, this, "Gives weapon with id i to v (all=-1, hammer=0, gun=1, shotgun=2, grenade=3, rifle=4, ninja=5)")
CONSOLE_COMMAND("removeweapon", "i[weapon-id] ?v[id]", CFGFLAG_SERVER|CMDFLAG_TEST, ConRemoveWeapon, this, "removes weapon with id i from v (all=-1, hammer=0, gun=1, shotgun=2, grenade=3, rifle=4, ninja=5)")
CONSOLE_COMMAND("shotgun", "?v[id]", CFGFLAG_SERVER|CMDFLAG_TEST, ConShotgun, this, "Gives a shotgun to player v")
CONSOLE_COMMAND("grenade", "?v[id]", CFGFLAG_SERVER|CMDFLAG_TEST, ConGrenade, this, "Gives a grenade launcher to player v")
CONSOLE_COMMAND("rifle", "?v[id]", CFGFLAG_SERVER|CMDFLAG_TEST, ConRifle, this, "Gives a rifle to player v")
CONSOLE_COMMAND("weapons", "?v[id]", CFGFLAG_SERVER|CMDFLAG_TEST, ConWeapons, this, "Gives all weapons to player v")
