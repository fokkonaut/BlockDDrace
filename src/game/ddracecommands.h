...
CONSOLE_COMMAND("removeweapon", "i[weapon-id] ?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_TEST, ConRemoveWeapon, this, "removes weapon with id i from v (all=-1, extra=-2, hammer=0, gun=1, shotgun=2, grenade=3, rifle=4, ninja=5)")
...
CONSOLE_COMMAND("unshotgun", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_TEST, ConUnShotgun, this, "Takes the shotgun from player v")
CONSOLE_COMMAND("ungrenade", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_TEST, ConUnGrenade, this, "Takes the grenade launcher player v")
CONSOLE_COMMAND("unrifle", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_TEST, ConUnRifle, this, "Takes the rifle from player v")
CONSOLE_COMMAND("unweapons", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_TEST, ConUnWeapons, this, "Takes all weapons from player v")
...
CONSOLE_COMMAND("unextraweapons", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_TEST, ConUnExtraWeapons, this, "Takes all extra weapons from player v")
...
CONSOLE_COMMAND("unplasmarifle", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_TEST, ConUnPlasmaRifle, this, "Takes the plasma rifle from player v")
CONSOLE_COMMAND("heartgun", "?v[id] ?i[spread]", CFGFLAG_SERVER, ConHeartGun, this, "Gives a heart gun to player v")
CONSOLE_COMMAND("unheartgun", "?v[id] ?i[spread]", CFGFLAG_SERVER, ConUnHeartGun, this, "Takes the heart gun from player v")
...
CONSOLE_COMMAND("unstraightgrenade", "?v[id] ?i[spread]", CFGFLAG_SERVER, ConUnStraightGrenade, this, "Takes the straight grenade from player v")
...
CONSOLE_COMMAND("ungun", "?v[id] ?i[spread]", CFGFLAG_SERVER|CMDFLAG_TEST, ConUnGun, this, "Takes the gun from player v")
...
CONSOLE_COMMAND("hookpower", "v[id] s[power]", CFGFLAG_SERVER, ConHookPower, this, "Sets hook power for player v")
