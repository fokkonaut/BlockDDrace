...
CONSOLE_COMMAND("infplasmagun", "?v[id]", CFGFLAG_SERVER, ConInfPlasmaGun, this, "Toggles infinite plasmagun for player v")
CONSOLE_COMMAND("heartgun", "?v[id]", CFGFLAG_SERVER, ConHeartGun, this, "Toggles heartgun for player v")
CONSOLE_COMMAND("infheartgun", "?v[id]", CFGFLAG_SERVER, ConInfHeartGun, this, "Toggles infinite heartgun for player v")
